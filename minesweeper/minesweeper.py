...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        self.knowledge = [sent for sent in self.knowledge if len(sent.cells) > 0]
            ...
            for sentence_2 in sentences_to_compare:
                if len(sentence_1.cells) > len(sentence_2.cells):
                    if sentence_1.cells.issuperset(sentence_2.cells):
                        inferred_sentences.append(Sentence(sentence_1.cells.difference(sentence_2.cells),sentence_1.count - sentence_2.count))
                elif len(sentence_1.cells) < len(sentence_2.cells):
                    if sentence_1.cells.issubset(sentence_2.cells):
                        inferred_sentences.append(Sentence(sentence_2.cells.difference(sentence_1.cells),sentence_2.count - sentence_1.count))
